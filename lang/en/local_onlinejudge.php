...
$string['status0'] = 'Waiting in line to be graded...';
$string['status1'] = 'Graded';
...
$string['status11'] = 'Incorrect';
$string['status21'] = 'Internal Error';
$string['status22'] = 'Grading in progress...';
